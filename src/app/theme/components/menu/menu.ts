...
export const horizontalMenuItems = [ 
    ...
    new Menu(2, 'EXTERNALISATION',null,null,null,true,0 ),
        new Menu(3, 'Partenariats Cabinets',null,'#cool',null,false,2),
        new Menu(4, 'Analyses/Diagnostiques', '/externalisation/analystes-diagnostiques',null,null,false,2),
    new Menu(5, 'SERVICES PROPOSES',null,null,null,true,0 ),
        new Menu(6, 'PAS : Prélèvement Source', '/services-proposes/prelevement-source',null,null,false,5 ),
        new Menu(7, 'Gestion complète paie', '/services-proposes/gestion-complete-paie',null,null,false,5 ),
        new Menu(8, 'Veille Légales/Conventionnelles', '/services-proposes/veille-legales-conventionnelles',null,null,false,5 ),
    new Menu(9, 'TARIFICATION',null,null,null,true,0 ),
        new Menu(10, 'Sur-mesure', '/tarification/sur-mesure',null,null,false,9),
        new Menu(11, 'Adaptée', '/tarification/adapte',null,null,false, 9 ),


    // new Menu(4, 'TARIFICATION', '/',null,null,false,0 ),
    // new Menu (2, 'NAV.EXTERNALISATION', '/properties', null, null, false, 0), 
